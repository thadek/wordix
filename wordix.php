...
/**
 * Solicita al usuario que ingrese un numero, y verifica que ese numero este entre $min y $max, 
 * que vienen por parametro.
 * @param int $min
 * @param int $max
 * @return int
 */
...
/**
 * Escribe por pantalla el mensaje de bienvenida del juego
 */
...
/**
 * Verifica que la cadena de texto que recibe por parametro sea una palabra válida, 
...
/**
 *  Lee una cadena de texto de 5 letras, verifica que la longitud sea de 5 letras y 
 *  llama a la funcion esPalabra para verificar sea una palabra valida. 
 *  En caso que se cumplan las condiciones retorna la palabra en mayusculas, 
 *  en caso contrario vuelve a solicitar la palabra.
 *  @return string
 */
